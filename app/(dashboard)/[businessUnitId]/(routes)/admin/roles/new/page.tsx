...
import { createRole, CreateRoleData } from '@/lib/actions/roles-management';
...
const NewRolePage: React.FC = () => {
  ...
  const handleInputChange = (field: keyof RoleFormData, value: string) => {
    setFormData(prev => {
      ...
      // Auto-generate name when displayName changes
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: `An error occurred while creating role: ${error}`,
        severity: 'error',
      });
    } finally {
      setLoading(false);
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  ...
                  <TextField
                    ...
                    fullWidth
                    disabled={loading}
                    helperText="Internal system name (auto-generated from display name)"
                    sx={{
                      '& .MuiOutlinedInput-root': {
                        borderRadius: '8px',
                        backgroundColor: darkTheme.background,
