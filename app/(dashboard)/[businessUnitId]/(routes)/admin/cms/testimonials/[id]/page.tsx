...
const EditTestimonialPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadTestimonial = async () => {
      try {
        ...
        if (testimonialData) {
          ...
          router.push(`/${businessUnitId}/admin/cms/testimonials`);
        }
      } catch (error) {
        setSnackbar({
          open: true,
    ...
    if (testimonialId && businessUnitId) {
      loadTestimonial();
    }
  }, [testimonialId, router, businessUnitId]);
    ...
    return (
      <Container maxWidth="xl" sx={{ py: 4, backgroundColor: darkTheme.background, minHeight: '100vh' }}>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '400px' }}>
          <Typography sx={{ color: darkTheme.text }}>Loading testimonial...</Typography>
        </Box>
      </Container>
    );
  }
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Typography sx={{ color: darkTheme.textSecondary, fontWeight: 600 }}>
                      Rating:
                    </Typography>
                    <Rating
