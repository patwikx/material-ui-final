...
// FIX: Added the missing 'specialFeatures' property
...
    roomTypeId: '',
    outOfOrderUntil: '',
    // FIX: Initialized the missing field
    specialFeatures: [],
  });
...
        roomImages: images.images.length > 0 ? images.images : undefined,
      };
...
      setSnackbar({
        open: true,
        message: `An error occurred while creating room ${error}`,
        severity: 'error',
      });
    } finally {
      setLoading(false);
